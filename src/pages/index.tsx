      ...
      <Container>
            ...
            <MainArea>
              ...
              <Item>
                <svg
                  ...
                  aria-hidden="true"
                >
                  <circle cx="17" cy="12" r="1.5" fill=" #d9d9d9"></circle>
                  <circle cx="12" cy="12" r="1.5" fill=" #d9d9d9"></circle>
                  <circle cx="7" cy="12" r="1.5" fill=" #d9d9d9"></circle>
                  <path
                    d="M12 22.75C6.072 22.75 1.25 17.928 1.25 12S6.072 1.25 12 1.25 22.75 6.072 22.75 12 17.928 22.75 12 22.75zm0-20C6.9 2.75 2.75 6.9 2.75 12S6.9 21.25 12 21.25s9.25-4.15 9.25-9.25S17.1 2.75 12 2.75z"
                    fill=" #d9d9d9"
                  ></path>
                </svg>
                <ItemText>もっとみる</ItemText>
              </Item>
              <Item>
        ...
        <Wrapper>
          ...
          <Timeline>
            ...
            <TimeLineArea>
              <UserInfo>
                <UserName>Poker大好き芸人</UserName>
                <UserAdress>@HoG3hoge_1234</UserAdress>
                <TweetedTime>5分前</TweetedTime>
              </UserInfo>
              <SomeTweet>
                6-MAX PKO
                DeepStuckトナメ、、、、インマネ直前のショートスタックで苦し紛れのBTNからK7オールインかましたらまさかのAA、、、終わったと思ったら俺まさかのツーペア！！まじで肩つえーわw
              </SomeTweet>
              <ReplyIcon>
                <ReplyIconSpan>
                  <ReplyIconArea>
...
const IconArea = styled.div`
  ...
  align-items: center;
`;
const IconAreaSpan = styled.span`
  margin-left: 2rem;
`;
...
const UserName = styled.div`
  ...
  color: #d9d9d9;
`;
const UserAdress = styled.div`
  padding-left: 0.5rem;
  font-size: 1.7rem;
  padding-top: 0.2em;
  color: #3b3a3a;
`;
const TweetedTime = styled.div`
  padding-left: 0.5rem;
  font-size: 1.7rem;
  color: #3b3a3a;
`;
const SomeTweet = styled.div`
  height: 60%;
  font-size: 1.6rem;
  padding-top: 1rem;
